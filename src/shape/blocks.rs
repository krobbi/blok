...
static BLOCKS: &[Blocks; Shape::COUNT * Facing::COUNT] = &[
    ...
    [(0, 0), (0, 1), (1, 1), (2, 1)], // Facing::Right
    [(0, 0), (0, 1), (1, 1), (2, 1)], // Facing::Down
    [(0, 0), (0, 1), (1, 1), (2, 1)], // Facing::Left

    // Shape::L
    [(2, 0), (0, 1), (1, 1), (2, 1)], // Facing::Up
    [(2, 0), (0, 1), (1, 1), (2, 1)], // Facing::Right
    [(2, 0), (0, 1), (1, 1), (2, 1)], // Facing::Down
    [(2, 0), (0, 1), (1, 1), (2, 1)], // Facing::Left
    ...
    [(1, 0), (2, 0), (0, 1), (1, 1)], // Facing::Right
    [(1, 0), (2, 0), (0, 1), (1, 1)], // Facing::Down
    [(1, 0), (2, 0), (0, 1), (1, 1)], // Facing::Left
